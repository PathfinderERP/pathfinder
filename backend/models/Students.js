...
const StudentsDetailsSchema = new mongoose.Schema({
  ...
  mobileNum: { type: String, required: true, match: /^[0-9]{8,15}$/ },
  whatsappNumber: { type: String, required: true, match: /^[0-9]{8,15}$/ },
...
const StudentSchema = new mongoose.Schema({
  ...
  deactivatedByUserId: { type: mongoose.Schema.Types.ObjectId, ref: 'User' },
