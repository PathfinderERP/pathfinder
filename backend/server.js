...
// Force restart timestamp: 2026-09-21T17:11:05
...
import boardCourseSubjectRoutes from "./routes/board/boardCourseSubject.routes.js";
import subjectRoutes from "./routes/subject/subject.routes.js";
import chequeRoutes from "./routes/Finance/chequeRoutes.js";
import chequeDepositRoutes from "./routes/Finance/chequeDeposit.routes.js";
...
import teacherTrainTimingRoutes from "./routes/Academics/teacherTrainTiming.routes.js";
...
import dailyTrackingLogRoutes from "./routes/dailyTrackingLog.routes.js";
import tomorrowPlannerRoutes from "./routes/tomorrowPlanner.routes.js";
import logCalendarRoutes from "./routes/logCalendar.routes.js";
...
app.use("/api/academics/train-timing", teacherTrainTimingRoutes);
...
app.use("/api/finance/cheque-deposit", chequeDepositRoutes);
...
app.use("/api/board-course-subject", boardCourseSubjectRoutes);
