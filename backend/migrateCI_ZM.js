...
const ALL_MODULES = {
    ...
    financeFees: ["feeManagement", "installmentPayment", "feeDueList", "chequeManagement", "chequeDepositEntry", "cancelCheque", "editBill", "payments", "paymentReminders", "cashReport", "cashTransfer", "cashReceive", "financialAnalysis", "centerTagging", "budget", "cashCentre", "partTimeTeachers", "financePerson", "vendorManagement", "payEmployee", "paymentAnalysis", "budgetAnalysis"],
