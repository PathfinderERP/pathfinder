...
async function run() {
    try {
        ...
        const existingStudent = await Student.findOne({ "studentsDetails.studentName": "TAMAJIT GHOSH" });
        if (existingStudent) {
        ...
        const admissionNumber = "PATH20001602";
        const session = "2026-2028";
        const totalAmount = 50000;

        // 1. Create Student
        const student = new Student({
            studentsDetails: [{
                studentName: "TAMAJIT GHOSH",
                class: "9",
                centre: centreName,
                mobileNum: "9999999999", // placeholder since not provided
                whatsappNumber: "9999999999",
                schoolName: "BARISHA HIGH",
                programme: "CRP"
            }],
            status: "Active",
            isEnrolled: true
