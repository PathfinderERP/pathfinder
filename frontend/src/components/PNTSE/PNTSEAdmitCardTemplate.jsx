...
import { formatAdmitCardTime } from '../../utils/admitCardUtils';

const PNTSEAdmitCardTemplate = forwardRef(({ student }, ref) => {
    ...
    // Pad roll number or use empty boxes
    ...
    return (
        <div ref={ref} className="w-[840px] bg-white text-black p-6 font-sans">
                        ...
                        <div className="flex gap-8">
                            <div className="flex items-end gap-2 flex-1">
                                ...
                                <div className="border-b-2 border-black flex-1 font-bold text-sm px-2 pb-0.5">
                                    {formatAdmitCardTime(student.reportingTime) || '-'}
                                </div>
                            </div>
                            <div className="flex items-end gap-2 flex-1">
...
PNTSEAdmitCardTemplate.displayName = 'PNTSEAdmitCardTemplate';

export default PNTSEAdmitCardTemplate;
