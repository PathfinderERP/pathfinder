                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label className="block text-gray-400 text-sm mb-1">
                                2-Digit Unique Code
                                <span className="ml-2 text-xs text-gray-500">(auto-generated if left blank)</span>
                            </label>
                            <input
                                type="number"
                                name="centreCode"
                        ...
                        <div className="md:col-span-2 mt-4 border-t border-gray-700 pt-4">
                            ...
                            {formData.locations.length > 0 ? (
                                ...
                                <p className="text-gray-500 text-sm italic mb-4">No extra locations added yet. Employees can check in at the main location selected above.</p>
                            )}
