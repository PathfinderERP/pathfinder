...
const Sidebar = ({ activePage = "CEO Control Tower", isOpen, toggleSidebar }) => {
    ...
    return (
        <div className={`
            fixed inset-y-0 left-0 z-50 w-64 bg-[#1a1f24] text-gray-400 flex flex-col h-screen border-r border-gray-800 transition-transform duration-300 ease-in-out
