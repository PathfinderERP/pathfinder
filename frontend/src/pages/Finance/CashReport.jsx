        ...
        <Layout activePage="Cash Report">
            <div className="p-4 md:p-6 space-y-8 animate-in fade-in duration-700">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        <h1 className={`text-2xl md:text-3xl font-black italic tracking-tight ${isDarkMode ? "text-white" : "text-gray-900"}`}>CASH INTELLIGENCE <span className="text-cyan-500">LEDGER</span></h1>
                    ...
                    <div className="flex items-center gap-3 w-full md:w-auto mt-4 md:mt-0">
                        ...
                        <select
                            ...
                            className={`border rounded-xl px-4 py-2 text-[10px] font-black outline-none focus:border-cyan-500 transition-all appearance-none cursor-pointer ${isDarkMode ? "bg-[#131619] border-gray-800 text-white" : "bg-white border-gray-300 text-gray-800"}`}
                        >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        <div className={`relative ${showCentreDropdown ? 'z-[110]' : 'z-10'}`} ref={centreDropdownRef}>
                            <button
                                ...
                                className={`w-full border rounded-xl py-3 pl-12 pr-4 focus:outline-none focus:border-cyan-500 transition-all text-sm flex items-center justify-between text-left ${isDarkMode ? "bg-gray-800/50 border-gray-700 text-white" : "bg-white border-gray-300 text-gray-800"}`}
                            >
                            ...
                            {showCentreDropdown && (
                                <div className={`absolute top-full left-0 right-0 mt-2 border rounded-2xl z-[9999] max-h-60 overflow-y-auto p-2 scrollbar-thin pointer-events-auto ${isDarkMode ? "bg-[#1a1f24] border-gray-700 shadow-[0_20px_50px_rgba(0,0,0,0.8)] scrollbar-thumb-gray-700" : "bg-white border-gray-300 shadow-xl scrollbar-thumb-gray-200"}`}>
                                    <div className={`flex justify-between items-center px-3 py-2 border-b mb-2 ${isDarkMode ? "border-gray-800" : "border-gray-200"}`}>
                                    ...
                                    <div className={`px-2 mb-2 sticky top-0 pb-2 border-b ${isDarkMode ? "bg-[#1a1f24] border-gray-800/50" : "bg-white border-gray-200"}`}>
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className={`w-full border rounded-lg py-1.5 pl-8 pr-3 text-[11px] focus:outline-none focus:border-cyan-500 transition-all placeholder:text-gray-500 ${isDarkMode ? "bg-gray-800/80 border-gray-700 text-white" : "bg-gray-50 border-gray-300 text-gray-800"}`}
                                            />
                                        </div>
                                    </div>
                                        ...
                                        {reportData
                                            ...
                                            .map(c => (
                                                ...
                                                >
                                                    ...
                                                    <span className={`text-[11px] font-bold ${filters.centreName.includes(c.centreName) ? (isDarkMode ? 'text-white' : 'text-gray-900') : (isDarkMode ? 'text-gray-400 group-hover:text-gray-300' : 'text-gray-600 group-hover:text-gray-800')}`}>
                                                        {c.centreName}
                                                    </span>
                                                </div>
                                            ))}
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`w-full border rounded-xl py-3 pl-12 pr-4 focus:outline-none focus:border-cyan-500 transition-all text-sm ${isDarkMode ? "bg-gray-800/50 border-gray-700 text-white" : "bg-white border-gray-300 text-gray-800"}`}
                    ...
                    <div className="flex flex-col lg:flex-row gap-4 items-center">
                        <div className="flex-[2] grid grid-cols-2 lg:grid-cols-4 gap-4 w-full">
                            <div className="relative">
                                ...
                                <input
                                    type="date"
                                    className={`w-full border rounded-xl py-3 pl-12 pr-4 focus:outline-none focus:border-cyan-500 transition-all text-sm ${isDarkMode ? "bg-gray-800/50 border-gray-700 text-white [color-scheme:dark]" : "bg-white border-gray-300 text-gray-800"}`}
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className={`w-full border rounded-xl py-3 px-4 focus:outline-none focus:border-cyan-500 transition-all text-sm ${isDarkMode ? "bg-gray-800/50 border-gray-700 text-white" : "bg-white border-gray-300 text-gray-800"}`}
                        ...
                        <button
                            ...
                            className={`w-full lg:w-auto px-8 py-3 border rounded-xl transition-all shadow-lg flex items-center justify-center gap-2 font-bold ${isDarkMode ? "bg-gray-800 border-gray-700 text-gray-400 hover:text-white" : "bg-gray-100 border-gray-300 text-gray-600 hover:bg-gray-200 hover:text-gray-900"}`}
                        >
                            <FaTimes /> Reset
                        </button>
                    </div>
                ...
                <div className={`backdrop-blur-xl border rounded-[2.5rem] overflow-hidden shadow-2xl ${isDarkMode ? "bg-[#131619]/60 border-gray-800" : "bg-white border-gray-200"}`}>
                    <div className="overflow-x-auto">
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className={`border-b ${isDarkMode ? "bg-gray-800/80 border-gray-700" : "bg-gray-100 border-gray-200"}`}>
                                        ...
                                        <tr key={item.centreId} className={`transition-all group ${isDarkMode ? "hover:bg-gray-800/30" : "hover:bg-gray-50"}`}>
                                            ...
                                            <td className="p-6">
                                                <div className="flex items-center gap-4">
                                                    <div className={`w-12 h-12 rounded-2xl flex items-center justify-center border group-hover:border-cyan-500/50 transition-all shrink-0 ${isDarkMode ? "bg-gray-800 border-gray-700" : "bg-gray-100 border-gray-200"}`}>
                                            ...
                                            <td className="p-6 text-right">
                                                <div className="space-y-1">
                                                    <span className={`text-xl font-black ${item.cashLeft > 0 ? (isDarkMode ? "text-emerald-400" : "text-emerald-600") : (isDarkMode ? "text-gray-600" : "text-gray-400")}`}>
                                            ...
                                            <td className="p-6 text-center">
                                                {item.lastActivity ? (
                                                    ...
                                                    <span className="text-gray-500 text-[10px] font-black uppercase tracking-widest italic">Stable</span>
                                                )}
                                            </td>
                                            ...
                                            <td className="p-6">
                                                <div className="space-y-1 max-w-[150px]">
                                                    <span className={`font-mono text-xs block truncate ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>{item.lastActivity?.referenceNumber || 'N/A'}</span>
                                            ...
                                            <td className="p-6">
                                                {item.lastActivity ? (
                                                    ...
                                                    <span className="text-gray-500 text-[10px] font-bold">No Movement</span>
                                                )}
                                            </td>
                                            ...
                                            <td className="p-6 text-center">
                                                <div className="flex items-center justify-center gap-2">
                                                    {item.lastActivity?.receiptFile && (
                                                        <a href={item.lastActivity.receiptFile} target="_blank" rel="noopener noreferrer" className={`p-2.5 rounded-xl hover:bg-cyan-600 hover:text-white transition-all border shadow-lg ${isDarkMode ? "bg-gray-800 text-cyan-400 border-gray-700" : "bg-white text-cyan-600 border-gray-300"}`} title="View Evidence">
                                                            <FaFileAlt />
                                                        </a>
                                                    )}
                                                    <button
                    ...
                    {!loading && mergedLedger.length > 0 && (
                        <div className={`mt-8 flex flex-col md:flex-row items-center justify-between gap-6 p-6 rounded-3xl border ${isDarkMode ? "bg-gray-900/30 border-gray-800/50" : "bg-gray-50 border-gray-200"}`}>
                            ...
                            <div className="flex items-center gap-3">
                                <button
                                    ...
                                    className={`p-3 border rounded-2xl text-gray-500 disabled:opacity-20 hover:text-cyan-400 transition-all active:scale-95 ${isDarkMode ? "bg-gray-800/50 border-gray-700/50" : "bg-white border-gray-300"}`}
                                >
                                        ...
                                        if (pageNum === 1 || pageNum === totalPages || (pageNum >= currentPage - 1 && pageNum <= currentPage + 1)) {
                                            return (
                                                <button
                                                    ...
                                                    className={`w-10 h-10 rounded-xl text-[10px] font-black transition-all active:scale-90 ${currentPage === pageNum ? 'bg-cyan-600 text-white shadow-xl shadow-cyan-900/40' : (isDarkMode ? 'bg-gray-800/30 border border-gray-800 text-gray-500 hover:bg-gray-800' : 'bg-white border-gray-300 text-gray-500 hover:bg-gray-100')}`}
                                                >
                                                    {pageNum}
                                                </button>
                                            );
