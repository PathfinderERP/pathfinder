        ...
        <div className="flex-1 bg-[#131619] p-6 overflow-y-auto text-white">
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
                <div>
                    ...
                    <p className="text-gray-400 text-sm mt-1">Manage finance-specific expense category definitions and imports.</p>
                </div>
                    ...
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody>
                            {loading ? (
                                ...
                                <tr>
                                    <td colSpan="4" className="p-4 text-center text-gray-500">No finance categories found</td>
                                </tr>
                            ) : (
