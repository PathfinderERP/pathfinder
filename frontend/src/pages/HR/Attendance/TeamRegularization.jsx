                        ...
                        <table className="w-full text-left border-collapse">
                            ...
                            <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                                {loading ? (
                                    ...
                                    <tr><td colSpan="11" className="px-6 py-10 text-center text-gray-400 text-sm italic">No reporting employee regularization requests found</td></tr>
                                )}
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div className="bg-white dark:bg-[#1a1f24] w-full max-w-md rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-800 overflow-hidden">
                        ...
                        <form onSubmit={handleBulkStatusUpdate} className="p-6 space-y-4">
                            ...
                            <div className="space-y-1.5">
                                <label className="text-[10px] font-bold uppercase text-gray-500 ml-1">Manager Remark (Optional)</label>
                                <textarea 
                                    rows="3" 
                                    value={bulkRemark} 
